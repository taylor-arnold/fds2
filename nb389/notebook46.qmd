...
11. Finally, read the communities the nearest-neighbor network found. Color the
network by `cluster`, and print each cluster's members. Check whether the groups
correspond to recognizable areas of law rather than falling out arbitrarily.
